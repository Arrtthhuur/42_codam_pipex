...
echo "Test 9: Command 1 doesn't exist."
...
echo "Test 10: Command 2 doesn't exist."
...
echo "Test 11: Command 1 invalid options."
...
echo "Test 12: Command 2 invalid option."
...
echo "Test 13: Outputfile without write permission."
...
echo "Test 14: Executable no execute permission."
...
echo "Test 15: Using pipe but not needed."
...
tmp_path="$PATH"
unset PATH
echo "Test 21: No PATH variable. NOTE: output files are not created. So red is good."
run_bash "< $file_in grep contents | wc -l > /tmp/file_out_bash"
run_pipex "$file_in" "grep contents" "wc -l" "/tmp/file_out_yours"
...
if [[ "$bonus" == "1" ]]; then
	...
	# Test 33
	echo "Test 22: Multiple commands"
